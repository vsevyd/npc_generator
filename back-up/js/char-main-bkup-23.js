...
document.getElementById('l_Attack').addEventListener("click", () => {
    ...
    if (showAttack === 'off') {
        ...
        document.getElementById('l_Defence').className = 'ah4 turn-right';
    }
});
...
// document.addEventListener('DOMContentLoaded', () => {
    ...
    CHAR.attack.forEach( function createAttackBlock(item, index, arr) {
        ...
        attack_Chars.className = "row lightcell row-bg-wt no-margin";
    ...
    CHAR.defence.forEach( function createDefenceBlock(item, index, arr) {
        ...
        defenceBlock.prepend(defence_Title); // вставить "defence_Title" в начало <`defenceBlock_#`>
            ...
            dShTt.innerHTML = arr[index].shortName;
        ...
        defence_Chars.className = "row lightcell row-bg-wt justify-content-start no-margin";
