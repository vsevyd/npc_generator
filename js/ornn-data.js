...
const ORNN = {
    ...
    armor:   [],
    attack:  [
		{ shortName:'Полэкс "МО"', longName:'Полэкс "Милость Отца" МР из гномьей стали', meel:true, complex:true,
		...
		{ shortName:'Маг.жезл "ПШ"', longName:'Магический жезл "Повелитель Штормов"', meel:false, complex:true,
		...
		{ shortName:'Заклинание', longName:'Орн, заклинание', meel:false, complex:true,
    ...
    defence: [
		{ shortName:'Пари&shyрование', longName:'Магический жезл, парирование', actionPoints:5, parry:16,},
		{ shortName:'Укло&shyнение',   longName:'Орн, уклонение',               actionPoints:2, parry:11,},
	],
};
