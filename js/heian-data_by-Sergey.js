...
const HEIAN = {
    ...
    attack:  [
		{ shortName:'Дервиш МР', longName:'Дервиш МР', meel:true, complex:true,
            ...
            wParts: [
                { attackName:'Рубить', attackDice:7, attackMod:0, damageDice:7, damageMod:2, armorPiercing:1, knockingDown:2, },
                { attackName:'Слабый удар', attackDice:6, attackMod:0, damageDice:6, damageMod:2, armorPiercing:1, knockingDown:2, },
                { attackName:'Оч. слабый удар', attackDice:5, attackMod:0, damageDice:5, damageMod:2, armorPiercing:1, knockingDown:2, },
                    ],
            enchantments: [
                { attackName:'Волшебное оружие', ammunition:5, attackDice:0, attackMod:3, damageDice:0, damageMod:3, },
                { attackName:'Разящий клинок', ammunition:1, attackDice:0, attackMod:0, damageDice:4, damageMod:1, reload:10, },
            ],
		...
		{ shortName:'Тесак МР', longName:'Тесак МР', meel:true, complex:true,
            ...
            wParts: [
                { attackName:'Рубить', attackDice:7, attackMod:0, damageDice:6, damageMod:2, armorPiercing:1, knockingDown:1, },
                { attackName:'Слабый удар', attackDice:6, attackMod:0, damageDice:5, damageMod:2, armorPiercing:1, knockingDown:1, },
                { attackName:'Оч. слабый удар', attackDice:5, attackMod:0, damageDice:4, damageMod:2, armorPiercing:1, knockingDown:1, },
                    ],
            enchantments: [
                { attackName:'Волшебное оружие', ammunition:5, attackDice:0, attackMod:3, damageDice:0, damageMod:3, },
            ],
        ...
        { shortName:'Метательный нож', longName:'Метательный нож', meel:false,
            ...
            enchantments: [
                { attackName:'Разящий клинок', ammunition:6, attackDice:0, attackMod:0, damageDice:4, damageMod:1, },
            ],
            range:2,
        ...
        { shortName:'Заклинание', longName:'Хэйан, заклинание', meel:false, complex:true, actionPoints:10, reload:false,
            attackDice:4, attackMod:0,
            wParts: [
                { attackName:'Заклинание', damageDice:7, damageMod:2, },],
                { attackName:'Слабое заклинание', damageDice:5, damageMod:1, },],
    ...
    defence: [
        ...
        { shortName:'Заклинание',   longName:'Защита от оружия', actionPoints:5, parry:27, },
	],
};
