...
const NATIONS_7S = {
    list: ['England', 'Spain', 'Germany', 'France', 'Poland', 'Russia', 'Norway', 'Italy',],
    England: 'Avalon',
    Scotland:'Highland',
    Ireland: 'Inismore',
    Spain:   'Castille',
...
const ORIGINS = {
    England: [
        {value: 'England', percent: 87.4,},
        {value: 'Scotland', percent: 3.6,},
        {value: 'Ireland', percent: 4.6,},
        {value: 'Spain',  percent: 0.5,},
        {value: 'Germany', percent: 0.2,},
        {value: 'France', percent: 0.3,},
        {value: 'Poland', percent: 1.2,},
        {value: 'Russia', percent: 0.1,},
        {value: 'Norway', percent: 0.1,},
        {value: 'Italy',  percent: 0.2,},
        {value: 'Cressent', percent: 0.3,},
        {value: 'Judas',  percent: 1.5,},
    ],
};
// старые базы данных
...
let tbl_SP_Religion = ["Vaticine", "Protestant", "Avalonian", "Orthodox", "muslim", "Judaist", "agnostic", "pagan", "other", "unknown",];
let prs_SP_Religion = [95.0, 1.21, 0.6, 0.5, 1.1, 0.03, 2.2, 0.05, 0.05, 0.05, ];
let tbl_GE_Religion = ["Vaticine", "Protestant", "Avalonian", "Orthodox", "muslim", "Judaist", "agnostic", "pagan", "other", "unknown",];
let prs_GE_Religion = [45.3, 44.8, 0.16, 1.14, 2.5, 0.12, 3.1, 2.3, 0.3, 0.3, ];
let tbl_FR_Religion = ["Vaticine", "Protestant", "Avalonian", "Orthodox", "muslim", "Judaist", "agnostic", "pagan", "other", "unknown",];
let prs_FR_Religion = [97.0, 2.0, 0.3, 1.0, 0.4, 0.6, 3.2, 0.05, 0.05, 0.05, ];
let tbl_SA_Religion = ["Vaticine", "Protestant", "Avalonian", "Orthodox", "muslim", "Judaist", "agnostic", "pagan", "other", "unknown",];
let prs_SA_Religion = [91.7, 0.36, 0.03, 1.3, 0.05, 0.05, 3.0, 1.5, 0.05, 2.05, ];
let tbl_US_Religion = ["Vaticine", "Protestant", "Avalonian", "Orthodox", "muslim", "Judaist", "Old Believer", "agnostic", "pagan", "other", "unknown",];
let prs_US_Religion = [9.19, 2.9, 0.0033, 70, 11.1, 4.15, 1.75, 2.27, 3.45, 0.05, 2.05, ];
let tbl_VE_Religion = ["Vaticine", "Protestant", "Avalonian", "Orthodox", "muslim", "Judaist", "agnostic", "pagan", "other", "unknown",];
let prs_VE_Religion = [11.1, 82.0, 1.11, 1.11, 1.1, 0.1, 3.33, 3.33, 0.3, 0.3, ];
let tbl_VO_Religion = ["Vaticine", "Protestant", "Avalonian", "Orthodox", "muslim", "Judaist", "agnostic", "pagan", "other", "unknown",];
